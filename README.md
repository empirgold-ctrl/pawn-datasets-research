...
Synthetic pawn-industry research datasets anchored to King Gold & Pawn.
...
- Latest summary: Synthetic customer segments describe visit cadence, ticket size, collateral preferences, and modeled repayment risk without exposing any real borrower identities. This build contains 37 rows under the consumer stress cycle scenario.

#### Version History

- `2026-04-16` | `consumer_stress_cycle` | rows `37` | realism `1.0`
  - Summary: Synthetic customer segments describe visit cadence, ticket size, collateral preferences, and modeled repayment risk without exposing any real borrower identities. This build contains 37 rows under the consumer stress cycle scenario.
...
- Latest summary: Synthetic daily gold-linked lending data tracks how price movement, jewelry exposure, loan volume, and repayment behavior move together over time. This build contains 37 rows under the high gold price cycle scenario.

#### Version History

- `2026-04-15` | `high_gold_price_cycle` | rows `37` | realism `1.0`
  - Summary: Synthetic daily gold-linked lending data tracks how price movement, jewelry exposure, loan volume, and repayment behavior move together over time. This build contains 37 rows under the high gold price cycle scenario.
  - Zenodo DOI: 10.5281/zenodo.19583190
  - Zenodo: https://zenodo.org/record/19583190
  - Figshare: https://api.figshare.com/v2/articles/32016027
  - Kaggle: https://www.kaggle.com/datasets/genefur/kgp-synthetic-gold-price-vs-pawn-activity
  - Github: https://github.com/empirgold-ctrl/pawn-datasets-research/blob/main/datasets/gold_price_vs_pawn_activity/2026-04-15/README.md
...
- `2026-04-05` | `high_gold_price_cycle` | rows `833` | realism `1.0`
  ...
  - Zenodo: https://zenodo.org/record/19429678
  - Openml: https://www.openml.org/d/47168
  - Kaggle: https://www.kaggle.com/datasets/genefur/kgp-synthetic-gold-price-vs-pawn-activity
  - Github: https://github.com/empirgold-ctrl/pawn-datasets-research/blob/main/datasets/gold_price_vs_pawn_activity/2026-04-05/README.md
...
- `2026-04-14` | `baseline` | rows `37` | realism `1.0`
  ...
  - Huggingface: https://huggingface.co/datasets/CollateralAnalytics/kgp-synthetic-pawn-loan-activity
...
- `refchecker_test_01` | `baseline` | rows `12523` | realism `1.0`
  ...
  - Kaggle: https://www.kaggle.com/datasets/genefur/kgp-synthetic-pawn-loan-activity-open
- `2026-04-04` | `baseline` | rows `12344` | realism `1.0`
  ...
  - Openml: https://www.openml.org/d/47167
  - Kaggle: https://www.kaggle.com/datasets/genefur/kgp-synthetic-pawn-loan-activity-open
  - Github: https://github.com/empirgold-ctrl/pawn-datasets-research/blob/main/datasets/pawn_loan_activity/2026-04-04/README.md
...
- `2026-04-03` | `holiday_liquidity_spike` | rows `252` | realism `1.0`
  - Summary: Synthetic regional market indicators capture how consumer stress, loan demand, redeem behavior, and gold dependency vary across New York operating areas. This build contains 252 rows under the holiday liquidity spike scenario.
  - Zenodo DOI: 10.5281/zenodo.19411057
  - Zenodo: https://zenodo.org/record/19411057
  - Openml: https://www.openml.org/d/47166
  - Kaggle: https://www.kaggle.com/datasets/genefur/kgp-synthetic-regional-pawn-market-conditions
  - Github: https://github.com/empirgold-ctrl/pawn-datasets-research/blob/main/datasets/regional_pawn_market_conditions/2026-04-03/README.md
